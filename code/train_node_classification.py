...
from models.modules import MergeLayer, MLPClassifier,NewLayer
...
if __name__ == "__main__":
    ...
    for run in range(args.num_runs):
        ...
        args.save_model_name = f'node_classification_{args.model_name}_seed{args.seed}_{name}'
        ...
        # link_predictor = NewLayer(hidden_dim=node_raw_features.shape[1],filter=args.filter)
        ...
        node_classifier = MLPClassifier(input_dim=node_raw_features.shape[1], filter=args.filter,dropout=args.dropout)
