...
if __name__ == "__main__":
    ...
    for run in range(args.num_runs):
        ...
        name='test'
        args.seed = run
        args.load_model_name = f'node_classification_{args.model_name}_seed{args.seed}_{name}'
        args.save_result_name = f'evaluate_node_classification_{args.model_name}_seed{args.seed}_{name}'
