...
def get_link_prediction_data(dataset_name: str, val_ratio: float, test_ratio: float, sample_ratio:float):
    """
    ...
    graph_df = pd.read_csv('/home/tianyuxing/DyGLib-master/processed_data/{}/ml_{}.csv'.format(dataset_name, dataset_name))
    edge_raw_features = np.load('/home/tianyuxing/DyGLib-master/processed_data/{}/ml_{}.npy'.format(dataset_name, dataset_name))
    node_raw_features = np.load('/home/tianyuxing/DyGLib-master/processed_data/{}/ml_{}_node.npy'.format(dataset_name, dataset_name))
    onehot='True'
    ...
    if node_raw_features.shape[1] < NODE_FEAT_DIM:
        ...
        # if onehot=='True':
    #     one hot
    # node_raw_features=np.eye(node_raw_features.shape[0])
